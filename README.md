...
测试验证行为不变量。完整中文教程与 Async Readiness Check 的当前版本位于
[Phi 课程文档分支](https://github.com/SingularityCoding/phi/tree/codex/async-lab-course-prework/docs/course/prework/async-lab)。
该分支合并后也会发布到 [Phi 课程网站](https://singularitycoding.github.io/phi/prework/async-lab/)。
